...
"""
269e3982fc25f1a743f3b5b8db6cd23a
oopython
lab2
v2
dapa22
...
Generated 2023-02-09 10:56:58 by dbwebb lab-utility v4.0.0 (2019-03-05).
...
# instance of Person. Give it the name `Goliat` and ssn `503233-4011`.
#
#
...
# `Lugard`, the state `Throvenland` and the country `Ademere` and store it in
...
#per = Person("Goliat", "503233-4011")
per_address = Address("Lugard","Throvenland", "Ademere")
...
# `Goliat` and ssn `503233-4011`.
# Use the add_course method to add the following courses, `ramverk2`, `webgl`
# and `oopython`.
#
#
...
teacher = Teacher("Goliat", "503233-4011")
...
# grade `4`, `oophp` with grade `-` and `javascript1` with grade `5`.
#
#
...
student = Student("MrStudent", "503233-4011")
student.address = Address("Karlskrona","Nättraby", "Östravägen 37")
student.add_course_grade("webgl", 4)
student.add_course_grade("oophp", "-")
student.add_course_grade("javascript1", 5)
